...
class ItemControllerTest extends TestCase
{
    ...
    public function test_store_fails_with_validation_error_invalid_type()
    {
        ...
        $response->assertStatus(422)
            ...
            ->assertJsonFragment([
                "itemDatas.itemName" => ["商品名は文字列でなければなりません。"],
                "itemDatas.price" => ["価格は数値でなければなりません。"],
                "itemDatas.asin" => ["ASINは10文字でなければなりません。", "ASINは文字列でなければなりません。"],
                "itemDatas.imageName" => ["画像名は文字列でなければなりません。"],
                "itemDatas.openWidth" => ["展開時の幅は数値でなければなりません。"],
                "itemDatas.openDepth" => ["展開時の奥行きは数値でなければなりません。"],
                "itemDatas.openHeight" => ["展開時の高さは数値でなければなりません。"],
                "itemDatas.storageWidth" => ["収納時の幅は数値でなければなりません。"],
                "itemDatas.storageDepth" => ["収納時の奥行きは数値でなければなりません。"],
                "itemDatas.storageHeight" => ["収納時の高さは数値でなければなりません。"],
                "itemDatas.weight" => ["重量は数値でなければなりません。"],
                "itemDatas.brandName" => ["ブランド名は文字列でなければなりません。"],
                "itemDatas.itemCategoryName" => ["商品カテゴリー名は文字列でなければなりません。"],
                "itemDatas.subCategoryName" => ["サブカテゴリー名は文字列でなければなりません。"],
                "itemDatas.colorTags.0" => ["カラータグは文字列でなければなりません。"],
