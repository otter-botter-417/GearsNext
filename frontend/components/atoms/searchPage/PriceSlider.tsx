...
import { ItemDataText } from "../itemPage/text/ItemDataText";
import { useRecoilValue, useSetRecoilState } from "recoil";

import { priceRangeState } from "../state/searchPage/priceRangeState";
import { priceDataState } from "../state/searchPage/priceDataState";
import { sliderValueState } from "../state/searchPage/sliderValueState";
...
export const PriceSlider = () => {
  ...
  const priceDataPoints = priceData.map((price) => ({ price }));
